...
public class Test {
	...
	public static void main(String[] args) {
		...
		Protocol p1 = new Protocol(co1, 1111, false, new InetSocketAddress("localhost", 2222));
		try {
			Thread.sleep(1000);
		...
		Protocol p2 = new Protocol(co2, 2222, true, new InetSocketAddress("localhost", 1111));
	}
